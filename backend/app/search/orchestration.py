...
class MaterialSearchGraph:
    ...
    def run(self, request: SegmentMatchRequest) -> SegmentMatchResponse:
        ...
        segmentation = final_state["segmentation"]
    ...
    def _build_graph(self):
        ...
        graph.add_node("segment_image", self._segment_image)
        ...
        graph.add_edge("prepare_run", "segment_image")
        graph.add_edge("segment_image", "match_regions")
    ...
    def _segment_image(self, state: SearchGraphState) -> SearchGraphState:
        request = state["request"]
